...
\begin{luacode}
  function contact(k, j)
    if j == '' then
      ...
      texio.write('****************************************')
      texio.write(resume['contact'][k][j])
      tex.sprint(resume['contact'][k][j])
    end
  end
\end{luacode}
\newcommand\getcontact[2]{\directlua{contact('#1','#2')}}
...
\namesection
  ...
  {
    \contactline
      {\href{\getcontact{site}{url}}{\getcontact{site}{displayText}}}
      {\href{\getcontact{github}{url}}{\getcontact{github}{displayText}}}
      {\href{\getcontact{linkedin}{url}}{\getcontact{linkedin}{displayText}}}
      {\href{\getcontact{email}{url}}{\getcontact{email}{displayText}}}
      {\href{\getcontact{phone}{url}}{\getcontact{phone}{displayText}}}
  }
